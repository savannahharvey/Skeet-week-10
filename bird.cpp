 ...
 *********************************************/
void Standard::draw(DrawDiskFunc drawDiskFunc)
{
   if (!isDead())
   {
      drawDiskFunc(pt, radius - 0.0, 1.0, 1.0, 1.0); // white outline
      drawDiskFunc(pt, radius - 3.0, 0.0, 0.0, 1.0); // blue center
   }
}
 ...
 *********************************************/
void Floater::draw(DrawDiskFunc drawDiskFunc)
{
   if (!isDead())
   {
      drawDiskFunc(pt, radius - 0.0, 0.0, 0.0, 1.0); // blue outline
      drawDiskFunc(pt, radius - 4.0, 1.0, 1.0, 1.0); // white center
   }
}
 ...
 *********************************************/
void Crazy::draw(DrawDiskFunc drawDiskFunc)
{
   if (!isDead())
   {
      drawDiskFunc(pt, radius * 1.0, 0.0, 0.0, 1.0); // bright blue outside
      drawDiskFunc(pt, radius * 0.8, 0.2, 0.2, 1.0);
      drawDiskFunc(pt, radius * 0.6, 0.4, 0.4, 1.0);
      drawDiskFunc(pt, radius * 0.4, 0.6, 0.6, 1.0);
      drawDiskFunc(pt, radius * 0.2, 0.8, 0.8, 1.0); // almost white inside
   }
}
 ...
 *********************************************/
void Sinker::draw(DrawDiskFunc drawDiskFunc)
{
   if (!isDead())
   {
      drawDiskFunc(pt, radius - 0.0, 0.0, 0.0, 0.8);
      drawDiskFunc(pt, radius - 4.0, 0.0, 0.0, 0.0);
   }
}
